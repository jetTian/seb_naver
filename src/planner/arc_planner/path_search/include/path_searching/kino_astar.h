...
#define inf 1 >> 30
  ...
  private:
    ...
    std::shared_ptr<se2_grid::SE2Grid> frontend_map_itf_;
    double non_siguav;
  ...
  public:
    ...
    // inital semantic map
    void intialMap(std::shared_ptr<se2_grid::SE2Grid> map_itf);
    ...
    bool isCollided(const Eigen::Vector3d &state);
