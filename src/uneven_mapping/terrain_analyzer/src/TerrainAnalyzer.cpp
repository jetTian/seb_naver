...
namespace terrain_analyzer
{
    ...
    bool TerrainAnalyzer::init(ros::NodeHandle& nh)
    {
        ...
        /* hxlin fixed */
        nh.getParam("/terrain_analyzer/elevation_map/ellipsoid_x", ellipsoid_x);
        nh.getParam("/terrain_analyzer/elevation_map/ellipsoid_y", ellipsoid_y);
        nh.param<std::vector<float>>("/terrain_analyzer/elevation_map/ellipsoid_offset", ellipsoid_offset, std::vector<float>());
        nh.getParam("/terrain_analyzer/elevation_map/iter_num", iter_num);

        nh.getParam("/terrain_analyzer/gpu_added_params/normal_radius", normal_radius);
        nh.getParam("/terrain_analyzer/gpu_added_params/max_phx", max_phx);
        nh.getParam("/terrain_analyzer/gpu_added_params/max_phy", max_phy);
        nh.getParam("/terrain_analyzer/gpu_added_params/max_curvature", max_curvature);
        nh.getParam("/terrain_analyzer/gpu_added_params/weight_phi", weight_phi);
        ...
        /* hxlin fixed */
        ellipsoid_offset_vec[0] = ellipsoid_offset[0];  //椭球偏移量
