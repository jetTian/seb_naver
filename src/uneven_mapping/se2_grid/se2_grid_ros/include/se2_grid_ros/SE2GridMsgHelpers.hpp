...
{
  if (message.layout.dim[0].label == se2_grid::storageIndexNames[se2_grid::StorageIndices::Column]) return false;
  else if (message.layout.dim[0].label == se2_grid::storageIndexNames[se2_grid::StorageIndices::Row]) return true;
